...
#if defined(NDEBUG)
# error "Alaris cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Alaris Signed Message:\n";
...
static const int64_t nTargetTimespan = 30;  // 30 seconds
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    unsigned int flags = SCRIPT_VERIFY_NOCACHE | SCRIPT_VERIFY_NULLDUMMY |
